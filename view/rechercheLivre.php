...
<body>
   ...
   <nav>
    ...
    <section>
        <h1 id="titre">Rechercher Livre</h1>
       <form action="rechercheLivre.php" method="post">
       ...
       <div class="cher">
        <div id="existe">
            <?php
                //------apller rechercheLivre_action.php ----------
                require_once "../controller/rechercheLivre_action.php";
                ?>
        </div>
        </div>
    </section>
