...
<head>
    ...
    <link rel="stylesheet" href="public/my_css/nouveauLivre.css"/>
    <title>Acceuil</title>
</head>
<body>
    <header>
    ...
    <nav>
        ...
        <section id="dashbord">
            <form method="POST" action="nouveauLivre.php">
                <legend><h2 id="titre">Nouveau Etudiant</h2></legend>
                Code <input type="number" name="code" id="code" placeholder="Saisir Code.."><br><br>
                Titre  <input type="text" name="titre" id="" placeholder="Saisir titre.."> <br><br>
                Auteur <input type="text" name="auteur" id="auteur" placeholder="Saisir auteur.."><br><br>
                Date d'edition <input type="date" name="date" id="date" placeholder="Saisir date.."><br><br>
                <input type="submit" value="Créer" name="submit">
            </form>
            <h1><?php 
                require_once '../controller/nouveauLivre_action.php' ;
            ?></h1>
        </section>
    </main>
</body>
