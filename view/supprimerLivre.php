...
<head>
    ...
    <link rel="stylesheet" href="public/my_css/supprimerLivre.css"/>
...
<header>
   ...
   <nav>
    ...
    <section>
        <h1 id="titre">Supprimer Livre</h1>
       <form action="supprimerLivre.php" method="POST">
           <label for="code">Code</label>
           <input type="number" name="codeS" id="codeS" placeholder="Saisir Code de livre..">
           <input type="submit" value="Supprimer" name="supprimer">
           <div id="suggesstion-box">
       </form>
       <div id="message">
       <?php
            require_once "../controller/supprimerLivre_action.php";
       ?>
       </div>
    </section>
    </main>
    ...
    <script>
        $(document).ready(function(){
            $("#codeS").keyup(function(){
                $.ajax({
                    method:"POST",
                    url: "../controller/supprimerLivre_action.php",
