...
<body>
   ...
   <nav>
    ...
    <section>
        ...
        <form action="modifierLivre_Form.php" method="POST">
            <label for="code">Code:</label>
            <input type="number" name="code" id="code" value=<?php echo $_SESSION['codeM'] ?>>
            <label for="titre">Titre:</label>
            <input type="text" name="titre" id="" value=<?php echo $_SESSION['titreM'] ?>>
            <label for="auteur">Auteur:</label>
            <input type="text" name="auteur" id="auteur" value=<?php echo $_SESSION['auteurM'] ?>>
            <label for="date">Date d'edition:</label>
            <input type="date" name="date" id="date" value=<?php echo $_SESSION['dateEditionM'] ?>>
            <input type="submit" value="Modifier" name="modifier">
        </form> 
        <h1>
            <?php
                require_once '../controller/modifierLivre_form_action.php';
            ?>
        </h1>
    </section>
    </main>
